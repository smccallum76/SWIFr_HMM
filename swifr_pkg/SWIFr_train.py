...
#def main(): # removed for debugging reasons
    ...
    parser.add_argument('--path',action='store',dest='path2files',default='test_data/hmm_example_4class/') # added for debugging reasons, the line commented above is the original
    parser.add_argument('--retrain',action='store_true',dest='retrain', default=False) # default should be False unless you want to retrain
    # put the arguments
    ...
    if args.retrain:
        ...
        print('Re-Training complete. Run the command swifr_test with --path2trained '+args.path2files)
    else:
        A.run_bic()
        A.plot_contours()
