...
#def main(): # commented out for debugging
    ...
    # parser.add_argument('--ode',action='store_true',dest='ode',default=False) #output_db non-normalized AODE output_db and inidividual ODE scores
    # args = parser.parse_args()

    # sdm modified lines
    parser = argparse.ArgumentParser()
    # location of the trained gmm model to use
    parser.add_argument('--path2trained',action='store',dest='path2trained',default='test_data/hmm_example_4class/')
    ...
    args.filename = 'test_data/hmm_example_4class_test/test/test'  # location of data that is to be classified
